  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <h3 className="mt-1.5 text-sm font-semibold text-gray-900">{insight.title}</h3>
          </div>
        </div>
        <div className="shrink-0 text-right">
          <p className="text-xs text-gray-500">{insight.metric.label}</p>
          <p className="text-lg font-bold text-gray-900">{insight.metric.value}</p>
        </div>
      </div>
      ...
      {insight.items.length > 0 && (
        <ul className="flex flex-col divide-y divide-gray-100 rounded-lg border border-gray-100 bg-gray-50/60">
